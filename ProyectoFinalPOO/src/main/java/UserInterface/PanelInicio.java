...
public class PanelInicio extends JPanel implements ActionListener {
    private JLabel fondoDerecha = new JLabel(new ImageIcon("data\\fondoLogin.png"));
    ...
    private void componentesIniciales() {
        ...
        this.fondoDerecha.add(this.etiquetaPassword);
        this.fondoDerecha.add(this.textLogin);
        this.fondoDerecha.add(this.textPassword);
        this.fondoDerecha.add(this.login);
        this.fondoDerecha.add(this.registro);
        this.add(this.fondoDerecha);
